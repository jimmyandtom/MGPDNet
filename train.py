...
def main(_run, _config, _log):
    ...
    log_loss = {'total_loss': 0, 'query_loss': 0, 'align_loss': 0, 'contrastive_loss': 0}
    ...
    for sub_epoch in range(n_sub_epochs):
        ...
        for _, sample in enumerate(train_loader):
            ...
            contrastive_loss = contrastive_loss.detach().data.cpu().numpy()
            ...
            log_loss['contrastive_loss'] += contrastive_loss
            ...
            if (i_iter + 1) % _config['print_interval'] == 0:
                ...
                _log.info(f'step {i_iter + 1}: total_loss: {total_loss}, query_loss: {query_loss},'
                          f' align_loss: {align_loss}, contrastive_loss: {contrastive_loss}')
